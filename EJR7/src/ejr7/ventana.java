...
public class ventana extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        n1.setSelectionColor(new java.awt.Color(153, 255, 255));
        ...
        jButton1.setText("¿Quién es mas grande?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
        uno =  Float.parseFloat(n1.getText());
}
catch(Exception e) {
        ...
        try {
        dos =  Float.parseFloat(n2.getText());
}
catch(Exception e) {
        JOptionPane.showMessageDialog(null, "Por favor ingrese un Número");
        n2.setText("");
    ...
    /**
     * @param args the command line arguments         dato.setText("");
     */
